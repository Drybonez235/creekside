...
1.  **Misaligned Intent:** Searches that do not match what the ad group is meant to sell (e.g., someone looking for "affiliate links" when you sell "referral software").
2.  **Competitors (When Not Targeting Them):** Exclude competitor brand names, especially when the intent is clearly navigational.
3.  **Post-Purchase/Informational:** These almost never convert in high-intent campaigns. Look for "instructions," "how to use," "manual," "reviews," "customer service," or "login."
...
**When to Use Phrase Match Negatives "Quotes":**
Use these **only** when the phrase never belongs in a buying search and won't overlap with valid intent.
