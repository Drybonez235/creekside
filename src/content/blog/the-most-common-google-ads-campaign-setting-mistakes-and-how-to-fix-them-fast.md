...
**Fix:**
Always select the marketing objective that best matches the business outcome you actually care about. If you’re running lead generation, tell Google that. This gives the algorithm clearer guardrails when it’s making bidding and placement decisions.
...
**Fix:**
Always uncheck **Display Network** in search campaigns. If you want display traffic, run a separate Display, Demand Gen, or Performance Max campaign with its own budget.
...
**Fix:**
Leave search partners off until you have consistent conversions and are running a conversion-based bidding strategy to scale volume.
...
**Fix:**
Only optimize for conversions that represent real business value. Monitor offline quality and remove actions that inflate numbers without driving revenue.
...
**Fix:**
If you don't have a robust customer list to upload, skip this setting. It’s an optimization lever, not a requirement.
...
**Fix:**
Always select **“Presence: People in or regularly in your targeted locations.”** No exceptions.
...
**Fix:**
Turn these off for new campaigns to maintain full control over your brand messaging.
...
**Fix:**
Disable automatic broad match and decide intentionally when to test it.
...
**Fix:**
Exclude internal IPs and exclude your brand unless running a dedicated brand campaign.
