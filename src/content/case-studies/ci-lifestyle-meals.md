...
sections:
  - type: "text"
    ...
    heading: "Growing a Smaller Brand in a Competitive Market"
    paragraphs:
  ...
  - type: "text"
    ...
    heading: "Pure New Customer Acquisition"
    paragraphs:
  ...
  - type: "text"
    ...
    heading: "Efficient Growth at Scale"
    paragraphs:
  ...
  - type: "image"
    imageUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663291059308/XxnH6o3BmuhXaMbCwgKnqi/ci-lifestyle-dashboard_5f9c3c7c.png"
  - type: "metrics-grid"
    cards:
      - value: "~14x"
        label: "Overall Account ROAS"
        context: "Total return across all campaign types, including both new and blended audience campaigns."
        variant: "highlight"
      - value: "4.52x"
        label: "New Customer ROAS"
        context: "Return on ad spend for campaigns that exclude all previous purchasers, purely net-new customers."
        variant: "success"
      - value: "~$25"
        label: "Cost Per Acquisition"
        context: "Average cost to acquire a brand-new customer, representing strong unit economics for a meal prep business."
        variant: "default"
      - value: "10K+"
        label: "Monthly Reach"
        context: "Tens of thousands of potential customers reached every month in the Portland/Vancouver market."
        variant: "default"
  - type: "highlight-box"
    bigStat: "4.52x"
    boxHeading: "New Customer ROAS"
    boxText: "This is the number that matters most. A 4.52x return on ad spend, achieved exclusively on new customers who have never purchased before, means CI Lifestyle Meals is generating $4.52 in revenue for every $1 spent on acquisition. At a $25 cost per new customer, the lifetime value math is overwhelmingly positive. These customers will continue to reorder week after week, making the initial acquisition cost a fraction of their total value to the business."
  - type: "text"
    sectionLabel: "Why It Matters"
    heading: "The Lifetime Value Equation"
    paragraphs:
  ...
  - type: "table"
    ...
    heading: "What This Campaign Proves"
    tableHeaders: ["Metric", "Value", "Significance"]
    tableRows:
      - cells: ["Overall ROAS", "~14x", "Total account performance across all campaigns"]
      - cells: ["New Customer ROAS", "4.52x", "Pure acquisition, excludes all previous purchasers"]
      - cells: ["Customer Acquisition Cost", "~$25", "Extremely efficient for a meal prep business"]
      - cells: ["Monthly Impressions", "10,000+", "Consistent brand visibility in the Portland market"]
